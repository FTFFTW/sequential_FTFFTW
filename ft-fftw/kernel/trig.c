...
static void rotate_sqrtn_table(triggen *p, INT m, R xr, R xi, R *res)
{
...

     {
	  ...
	  trigreal wr = wr1 * wr0 - wi1 * wi0;
       register trigreal dmr = wr1 * wr0 - wi1 * wi0;
       if(wr != dmr)
       {
          printf("error in twiddles, rotate_sqrtn_table wr\n");
          wr = wr1 * wr0 - wi1 * wi0;
       }
	  trigreal wi = wi1 * wr0 + wr1 * wi0;
       ...
       if(wi != dmr)
       {
          printf("error in twiddles, rotate_sqrtn_table wi\n");
          wr = wi1 * wr0 + wr1 * wi0;
       }
	  ...
	  res[0] = xr * wr + xi * wi;
       ...
       if(res[0] != dmr)
       {
          printf("error in twiddles, rotate_sqrtn_table res0\n");
          res[0] = xr * wr + xi * wi;
       }
	  res[1] = xi * wr - xr * wi;
       dmr = xi * wr - xr * wi;
       if(res[1] != dmr)
       {
          printf("error in twiddles, rotate_sqrtn_table res1\n");
          res[1] = xi * wr - xr * wi;
       }
#else
	  res[0] = xr * wr - xi * wi;
